...
image_path = 'Image_Annotation/example.jpg'  # Replace with your image path
...
cv2.rectangle(image, top_left1, bottom_right1, (0, 255, 255), 3)  # Yellow rectangle

# Rectangle 2: Bottom-right corner
rect2_width, rect2_height = 200, 150
top_left2= (width - rect2_width - 20, height - rect2_height - 20)  # Fixed 20 pixels padding from bottom-right
bottom_right2= (top_left2[0] + rect2_width, top_left2[1] + rect2_height)
cv2.rectangle(image, top_left2, bottom_right2, (255, 0, 255), 3)  # Magenta rectangle
...
cv2.putText(image, 'Region 1', (top_left1[0], top_left1[1] - 10), font, .7, (0, 255, 255), cv2.LINE_AA)
cv2.putText(image, 'Region 2', (top_left2[0], top_left2[1] - 10), font, .7, (255, 0, 255), cv2.LINE_AA)
cv2.putText(image, 'Center 1', (center1_x - 40, center1_y + 40), font, .6, (0, 255, 0), cv2.LINE_AA)
cv2.putText(image, 'Center 2', (center2_x - 40, center2_y + 40), font, .6, (0, 0, 255), cv2.LINE_AA)
...
cv2.arrowedLine(image,arrow_start,arrow_end, (255,255,0), 3, tipLength= 0.05)  # Downward arrow
cv2.arrowedLine(image,arrow_end,arrow_start, (255,255,0), 3, tipLength= 0.05) # Upward arrow

# Annotate the height value
height_label_position= (arrow_start[0] -150, (arrow_start[1] + arrow_end[1]) // 2)
cv2.putText(image, f'Height: {height} px', height_label_position, font, .8, (255, 255, 0), cv2.LINE_AA)
